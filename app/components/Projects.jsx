...
export default function Projects({ myRef }) {
  return (
    <div  ref={myRef} className='flex flex-col items-center justify-center scale-[.6] sm:scale-[.85] md:scale-[1] scroll-mt-[6rem]'>
      ...
      <a href="https://github.com/connortoro/postoro" target="_blank" className='project shadow-2xl flex flex-col bg-gradient-to-r from-neutral-800 to-neutral-900 h-[20rem] w-[38rem] rounded-[1.5rem]'>
        <h2 className='text-left py-[1.5rem] pt-[2.5rem] pl-[2.5rem] text-4xl font-extrabold text-neutral-200'>Postoro 💻</h2>
        <h2 className='text-right gradient-n text-lg text-neutral-300 p-[1rem] pl-[7rem] pr-[2rem]'>My own social media website. With user authentication letting users post updates and photos with liking, commenting, and following</h2>
        <h2 className='text-left text-neutral-300 p-[1rem] mt-[0rem] ml-[1rem]'>
          ...
          <span className='bg-neutral-600 text-neutral-400 py-[.2rem] px-[.5rem] rounded-full mr-[.4rem]'>AWS S3 </span>
        </h2>
      </a>
