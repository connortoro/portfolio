...
export default function Projects() {
  return (
    <div className='flex flex-col items-center justify-center scale-[.6] sm:scale-[.85] md:scale-[1]'>
      <h3 className='text-stone-300 mb-[2rem] mt-[1rem] font-semibold'>Projects</h3>

      <a href="https://musical-connections.vercel.app" target="_blank" className='project shadow-2xl flex flex-col bg-gradient-to-r from-stone-800 to-stone-900 h-[20rem] w-[38rem] rounded-[2rem] -z-50'>
      ...
      <div className="h-[4rem] my-[.86rem] w-[2px] bg-stone-600 opacity-70"></div>

      <a href="https://musical-connections.vercel.app" target="_blank" className='project shadow-2xl flex flex-col bg-gradient-to-l from-stone-800 to-stone-900 h-[20rem] w-[38rem] rounded-[2rem]'>
      ...
      <a href="https://musical-connections.vercel.app" target="_blank" className='project shadow-2xl flex flex-col bg-gradient-to-r from-stone-800 to-stone-900 h-[20rem] w-[38rem] rounded-[2rem]'>
        <h2 className='text-left gradient py-[1.5rem] pt-[2.5rem] pl-[2.5rem] text-4xl font-extrabold'>Musical Connections</h2>
        <h2 className='text-right gradient-n text-lg text-stone-300 p-[1rem] pl-[7rem] pr-[2rem]'>Daily puzzles of a New York Times connections like game, using musical artists and their songs. User sign in and authentication with a puzzle archive and progress tracking </h2>
        <h2 className='text-left text-stone-300 p-[1rem] mt-[0rem] ml-[1rem]'>
          <span className='bg-stone-600 text-stone-400 py-[.2rem] px-[.5rem] rounded-full mr-[.4rem]'>React</span>
          <span className='bg-stone-600 text-stone-400 py-[.2rem] px-[.5rem] rounded-full mr-[.4rem]'>MongoDB </span>
