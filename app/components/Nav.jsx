...
export default function Nav({ navigate, selected }) {
  ...
  const selectedClass = (section) => {
    if(section === selected) {
      return ' bg-neutral-500 text-neutral-200'
    } else {
  ...
  return (
    <>
      ...
      <nav className=" opacity-[.9] drop-in flex justify-center pt-4  sm:bg-inherit bg-neutral-400 w-screen fixed top-0 z-50">
        <div className='flex flex-row items-center justify-center bg-neutral-400 content-center sm:w-min w-min rounded-full sm:px-3 px-1 md:px-2 py-1 scale-[.85]'>
