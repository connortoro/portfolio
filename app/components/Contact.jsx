...
export default function Contact({ myRef }) {
  ...
  return (
    <div ref={myRef} className='flex flex-col items-center justify-center mb-[20rem] scroll-mt-[6rem]'>
        ...
        <form className='flex flex-col sm:w-[33rem]  mt-[2.5rem]' action={(formData) => sendEmail(formData)}>
            ...
            <textarea className='bg-stone-700 mb-[1rem] rounded-[.4rem] text-stone-200 pl-[.85rem] h-[12rem] pt-[.4rem]' name='message' placeholder='Your Message'/>
