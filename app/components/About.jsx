...
export default function About({ myRef }) {
  return (
    <div ref={myRef} className='flex flex-col justify-center items-center content-center scroll-mt-[6rem]'>
      <h3 className='text-neutral-300 my-[1.3rem] font-semibold text-xl'>About</h3>
      <p className='text-neutral-400 text-center sm:w-[43rem] font-normal px-7 md:px-0'>As a computer science student I am driven to become a software engineer and make an impact
